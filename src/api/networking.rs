...
pub mod networking {
    ...
    pub fn is_p2p_packet_available() -> i32 {
        ...
        log_function_call("networking.is_p2p_packet_available", &[], &result);
        result
    }
    ...
    pub fn read_p2p_packet(size: i32) -> Result<P2PPacket, Error> {
        ...
        log_function_call("networking.read_p2p_packet", &[&size], &result.is_ok());
        result
    }
    ...
    pub fn accept_p2p_session(steam_id64: BigInt) {
        ...
        log_function_call("networking.accept_p2p_session", &[&steam_id64], &"()");
    }
}
